# ================================================================
# HARDNESS XGBOOST MODEL
# Composition + Physical/Microstructural Features
# XGBoost 2.1.4
# ================================================================
...
MODEL_OUTPUT = "Hardness_XGBoost_Model.pkl"
PREDICTION_OUTPUT = "Hardness_XGBoost_Predictions.csv"
METRICS_OUTPUT = "Hardness_XGBoost_Metrics.csv"
IMPORTANCE_OUTPUT = "Hardness_XGBoost_Feature_Importance.csv"
...
if (
    "record_id" not in clean_df.columns
    or "record_id" not in pg_df.columns
):
...
print("\n" + "=" * 70)
print("HARDNESS XGBOOST RESULTS")
print("=" * 70)
...
print(
    "\nHardness XGBoost completed successfully."
)