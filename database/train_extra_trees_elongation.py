...
print("=" * 70)
print("EXTRA TREES - ELONGATION MODEL 4")
...
clean_df = pd.read_csv("Elongation_ML_Dataset.csv")
...
print("PostgreSQL joined data:", pg_df.shape)
...
clean_df["_match_key"] = make_match_key(clean_df)
pg_df["_match_key"] = make_match_key(pg_df)
...
print("\nMatched PostgreSQL records:", len(df))
...
print("\n" + "=" * 70)
print("ELONGATION MODEL 4 RESULTS")
print("=" * 70)
...
predictions.to_csv(
    "Elongation_ExtraTrees_Predictions.csv",
    index=False
)
...
joblib.dump(
    pipeline,
    "Elongation_ExtraTrees_Model.pkl"
)
...
print("\n" + "=" * 70)
print("ELONGATION MODEL 4 COMPLETE")
print("=" * 70)