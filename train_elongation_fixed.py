...
print("=" * 70)
print("CORRECTED ELONGATION MODEL TRAINING")
print("=" * 70)
...
# Remove exact duplicate feature/target rows
before = len(df)
...
print("\nElongation records:", len(df))
print("Exact duplicate rows removed:", removed)
print("Unique compositions:", df[GROUP].nunique())
...
for i, name in enumerate(feature_names[:40]):
    print(i, name)
...
print("\n" + "=" * 70)
print("CORRECTED ELONGATION RESULTS")
print("=" * 70)
